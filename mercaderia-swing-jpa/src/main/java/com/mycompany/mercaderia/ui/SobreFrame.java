...
import static com.mycompany.mercaderia.util.ApplicationProperties.getBuild;
import static com.mycompany.mercaderia.util.ApplicationProperties.getDesenvolvidoPor;
import static com.mycompany.mercaderia.util.ApplicationProperties.getSite;
import static com.mycompany.mercaderia.util.ApplicationProperties.getTitulo;
import static com.mycompany.mercaderia.util.ApplicationProperties.getURLLogo;
import static com.mycompany.mercaderia.util.ApplicationProperties.getVersao;
...
public class SobreFrame extends JFrame {
	...
	private JPanel montaLabelsSobre() {
        ...
        JLabel l1 = new JLabel("Aplicacion:");
        JLabel l2 = new JLabel("Version:");
        JLabel l3 = new JLabel("Desarrollado por:");
